  ...
  padding: 1px 1px 1px ;
   ...
   <!-- <ul class="nav  navbar-right">
	...
	<div class="col-sm-10">
		...
		<form role="form" align="center" class="form-horizontal col-md-10 col-md-offset-2" data-toggle="validator" onSubmit="return validate();" id ="form2" action="formSubmit-DonorRegistration.php" method="post"><!--changed-->

			<p><h4><b><legend><font color="green" size="5px"> Donor Registration Form</font> </legend></b></h4></p>
			<p>
				<h4>
				<b>
					<font color="red">
		...
		<div class="row">
			<div class="jumbotron">
				...
				<p><h5><b><font color="red">  Personal Details</font></b></h5><h6>We recommend on the privacy of your details</h6></p>
				<!--<br>-->
							<div class="form-group" align = "center">
				...
				<p><h5><b><font color="red">  Contact Details</font></b></h5></p>
				<br>
				...
				<p><h5><b><font color="red">  Medical Details</font></b></h5></p>
				<!--<br>-->
							...
							<div class="form-group" align = "center">
								...
								<div class="col-md-4">
									<font color="green"><label><input type="radio" name="Blood" value="A+" checked="checked" >A+</label></font>
									<font color="green"><label><input type="radio" name="Blood" value="A-">A-</label></font>
									<font color="green"><label><input type="radio" name="Blood" value="B+">B+</label></font>
									<font color="green"><label><input type="radio" name="Blood" value="B-">B-</label></font><br>
									<font color="green"><label><input type="radio" name="Blood" value="AB+">AB+</label></font>
									<font color="green"><label><input type="radio" name="Blood" value="AB-">AB-</label></font>
									<font color="green"><label><input type="radio" name="Blood" value="O+">O+</label></font>
									<font color="green"><label><input type="radio" name="Blood" value="O-">O-</label></font>
							...
							<div class="form-group" align = "center">
								<div class="radio">
									<label for="Gender" class="col-md-4 control-label"><font color="green">
										<b>Do you have any health issues?:*</b>
										</font>
									</label>
								<div class="col-md-3">
									<font color="green"><label><input type="radio" name="issues" value="yes" checked="checked" >Yes</label></font>
									<font color="green"><label><input type="radio" name="issues" value="no" >No</label></font>
									<br></div>
									<div class="col-md-8">
										<textarea class="form-control" rows="3" cols="5" name="health_issues" placeholder="If yes mention here" ></textarea>
									</div>
			...
			$(document).ready(function()
			{
				...
				}).on('keyup', '[name="password"]', function()
				{
					// Enable the password/confirm password validators if the password is not empty
						...
						{
							$('#form2').formValidation('validateField', 'password').formValidation('validateField', 'passwordc');
						}
				});
			});
			*/
