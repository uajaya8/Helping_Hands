...
<div class="jumbotron">
	...
	<form role="form" align="center"  id="login" action="DonorLoginSubmit.php" method="post">
		<div class="header"><font size="6px" color="green">Login as a Donor</font></div><br>
		  ...
		  <br><a href="DonorRegistration.php"><font align="center" color="green">New User?</font></a>
