...
<br><br><br><br>-->
	...
	<div class="col-sm-10 col-sm-offset-1 "><br>
		...
		<form role="form" align="center" class="form-horizontal col-md-10 col-md-offset-1" data-toggle="validator" onSubmit="return validate();" id ="form2"action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
			...
			<p><h4><b><legend>  Search for a compatible patient</legend></b></h4></p>
			...
			<div class="jumbotron">
				<div class="form-group" align = "center">
							...
							<div class=" control-group success">
							   <div class="controls">
									<button type="submit" class="btn-lg btn-success" name="patient-search-submit">Search</button>
							   </div> 
							</div>
...
//							SELECT * FROM tbl_patient WHERE patient_blood='A+' OR 'A-'



							$sql = "SELECT * FROM tbl_patient WHERE patient_blood=".$blood_type;
							$query = mysql_query($sql);

						/*	while($result = mysql_fetch_array($query))
							{
								echo $result['patient_name'];
                                echo $result['patient_gender'];
								echo $result['patient blood'];
								echo $result['email'];
								echo $result['contact'];
								echo $result['contact2'];
						...
						?>*/
						?>
						<h3 class="h1Search"><div class="SubHeader1">Patient Details</div></h3>
    ...
    ?>
        <tr>
            ...
            <td><?php echo($result['patient_blood'])?></td>
